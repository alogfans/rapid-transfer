// rapid_transfer_protocol.h
//
// RapidTransfer v2.0 Unified Protocol Definition
// All messages are data packets, distinguished by flags
//
// Copyright (C) 2026 RapidTransfer Team

#ifndef RAPID_TRANSFER_PROTOCOL_H_
#define RAPID_TRANSFER_PROTOCOL_H_
...
struct __attribute__((packed)) RapidTransferHeader {
...
constexpr size_t kMaxPacketsPerChunk =
    64;  // Max packets per chunk (bitmap size)
constexpr uint64_t kChunkCompleteMask = 0xFFFFFFFFFFFFFFFFULL;

}  // namespace v1
}  // namespace rapid

#endif  // RAPID_TRANSFER_PROTOCOL_H_
