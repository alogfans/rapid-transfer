...
namespace rapid
{
    ...
    std::shared_ptr<RdmaReliableProtocol::Task> RdmaReliableProtocol::allocateTask(RequestType type)
    {
    ...
    std::shared_ptr<RdmaReliableProtocol::Task> RdmaReliableProtocol::getTaskById(TaskID task_id)
    {
